...
func Parse() *Config {
	...
	flag.Usage = func() {
		...
		fmt.Fprintf(os.Stderr, "  -n <count>            Max JS fetch attempts, including failures (0=unlimited)\n")
	...
	flag.IntVar(&cfg.MaxJS, "n", 0, "Max JS fetch attempts, including failures (0=unlimited)")
